...
# ... (Funkcje Google Sheets, Geokodowania itp. pozostają bez zmian jak w v129) ...
...
# --- 4. STYLE CSS (PIKSELOWA PERFEKCJA) ---
st.markdown("""
<style>
    /* Pasek informacyjny */
    .info-bar {
    ...
    /* Reset przycisku Streamlit */
    div.stButton > button {
        border-radius: 8px !important;
        height: 42px !important; /* Ta sama wysokość co pasek */
        margin: 0 !important;
        padding: 0 !important;
    ...
    /* Usunięcie domyślnych odstępów między kolumnami w tym rzędzie */
...
# --- 7. PANEL GŁÓWNY (UKŁAD 4 KOLUMNY) ---
st.title("🗺️ Optymalizator Tras")

# Ustawiamy vertical_alignment na "center" dla całego rzędu
col1, col2, col3, col4 = st.columns([0.4, 0.05, 0.4, 0.05], vertical_alignment="center")
...
with col4:
    if st.session_state["meta_name"] != "Nie wybrano":
        if st.button("✖", key="clear_m_v130"):
            st.session_state.update({'meta_name': "Nie wybrano", 'meta_coords': None})
            st.rerun()

st.markdown("<br>", unsafe_allow_html=True)

# ... (Reszta kodu: logika pomocnicza, mapa i obliczenia bez zmian) ...
